...
regions as 
(SELECT eez , 
gridcode FROM `world-fishing-827.pipe_static.spatial_measures_20201105` 
...
from 
  `world-fishing-827.proj_global_sar.detections_w_features_v20220812`
),
...
from
   `world-fishing-827.gfw_research.vi_ssvid_v20221001`
