...
# +
table_id = 'world-fishing-827.proj_global_sar.detections_w_overpasses_v20220509'
...
# +
table_id = 'world-fishing-827.proj_global_sar.detections_w_overpasses_v20220805'
query_to_table(q, table_id)
...
# +
table_id = 'world-fishing-827.proj_global_sar.detections_w_overpasses_v20220929'
query_to_table(q, table_id)
...
table_id = 'world-fishing-827.proj_global_sar.detections_w_overpasses_v20230215'
query_to_table(q, table_id)
...
# +
table_id = 'world-fishing-827.proj_global_sar.detections_w_overpasses_rolling24_v20220805'
# query_to_table(q, table_id)
