...
(select * from `world-fishing-827.proj_global_sar.detections_w_overpasses_v20230215`),
...
(SELECT 
  ...
  date
FROM 
  `world-fishing-827.proj_global_sar.overpasses_200_every24days_v20220805` 
),
...
query_to_table(query, 'world-fishing-827.proj_global_sar.detections_24_w_zeroes_v20230219')
...
update_table_description("world-fishing-827.proj_global_sar.detections_24_w_zeroes_v20230219", 
                        description)
# -
...
detection_source_table as 
(select * from `world-fishing-827.proj_global_sar.detections_w_overpasses_v20220929`),
...
select
  ...
  if(on_fishing_list_known is not null, on_fishing_list_known, on_fishing_list_nn) as on_fishing_list
from
   `world-fishing-827.gfw_research.vi_ssvid_v20221101`
  -- don't do anything with identity spoofing vessels!
  where activity.overlap_hours_multinames < 24
),
